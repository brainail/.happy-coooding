/*
 * Big integer implementation v2
 *
 * Author: Howard Cheng
 *
 * Each digit in our representation represents LOG_BASE decimal digits
 *
 * Revised: Nov 30 1999 by Howard Cheng
 *  - added convert_from_int() and convert_to_int() to do conversions
 *    between integers
 *  - added short_divide() to divide a bignum by a small integer (< BASE)
 *  - rewrote divide(), more typing but much faster
 */
