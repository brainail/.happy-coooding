...
import static utilities.vector.Common.*;
    ...
    implements Serializable, Cloneable
{
    ...
    public final void setElement(int row, int column, double value)
    {
        ...
        case 0:
            ...
            case 2:
                ...
                break;
            default:
                throw new ArrayIndexOutOfBoundsException("Matrix3d0");
            }
            break;
    ...
    public final double getElement(int row, int column)
    {
        ...
        throw new ArrayIndexOutOfBoundsException("Matrix3d1");
    }
    ...
    public final void getRow(int row, Vector3d v)
    {
        if (row == 0) {
            ...
            throw new ArrayIndexOutOfBoundsException("Matrix3d2");
        }
    ...
    public final void getColumn(int column, Vector3d v)
    {
        if (column == 0) {
            ...
            throw new ArrayIndexOutOfBoundsException("Matrix3d4");
        }
    ...
    public final void setRow(int row, double x, double y, double z)
    {
        ...
        default:
            throw new ArrayIndexOutOfBoundsException("Matrix3d6");
        }
    }
    ...
    public final void setColumn(int column, double x, double y, double z)
    {
        ...
        default:
            throw new ArrayIndexOutOfBoundsException("Matrix3d9");
        }
    }
    ...
    private final void invertGeneral(Matrix3d m1)
    {
        ...
        if (!luDecomposition(tmp, row_perm)) {
            ...
            throw new RuntimeException("SingularMatrixException: Matrix3d12");
        }
    ...
    // 1988, pp 44-45.
    //
    static void luBacksubstitution(
        double[] matrix1,
        int[] row_perm,
        double[] matrix2)
    {
