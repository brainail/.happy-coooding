    ...
    implements Comparable<Fraction>
{
     ...
     *            sevenths'
     * @param denominator the denominator, for example the seven in 'one and
     *            three sevenths'
     * @return a new fraction instance
     * @throws ArithmeticException if the denomiator is <code>zero</code>
    ...
    public static Fraction getFraction(double value)
    {
        ...
        do {
            ...
            // delta2)+" "+i+" "+denom2);
        } while ((delta1 > delta2) && (denom2 <= 10000) && (denom2 > 0)
                        && (i < 25));
        if (i == 25) {
            throw new ArithmeticException(
    ...
    private Fraction addSub(Fraction fraction, boolean isAdd)
    {
        ...
        if (d1 == 1) {
            ...
            return new Fraction(isAdd ? addAndCheck(uvp, upv) : subAndCheck(
                uvp, upv), mulPosAndCheck(denominator, fraction.denominator));
        }
