...
double dp [200 + 10][100 + 10][100 + 10];
...
//        calc(0, k / 2, k / 2);
        ...
        _forn(i, 0, kk)
            _forn(_k1, 0, k1 + 1)
                _forn(_k2, 0, k2 + 1) {
                    if (_k1 + 1 <= k1) {
                        dp [i + 1][_k1 + 1][_k2] += dp [i][_k1][_k2] * rp [i];
                    }
                    if (_k2 + 1 <= k2) {
                        dp [i + 1][_k1][_k2 + 1] += dp [i][_k1][_k2] * (1.0 - rp [i]);
                    }
                }
