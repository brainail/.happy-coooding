...
const string INPUT_FILE
        = IDE_PATH + "CROC/2016/00_QualificationRound/input.txt";
const string OUTPUT_FILE
        = IDE_PATH + "CROC/2016/00_QualificationRound/output.txt";
...
int main() {
    ...
    _forn(i, 0, N) {
        _forn(j, 0, M) printf("%d ", board [i][j]);
        printf("\n");
    }
    // CODE AREA <=
