...
const string INPUT_FILE
        = IDE_PATH + "Codechef/2017/MayChallenge/input.txt";
const string OUTPUT_FILE
        = IDE_PATH + "Codechef/2017/MayChallenge/output.txt";
...
int main() {
    ...
    forT(testId) {
        ...
        int moment = 0;
        while (moment < n && 'C' == s [moment]) ++ moment;
        while (moment < n && 'E' == s [moment]) ++ moment;
        while (moment < n && 'S' == s [moment]) ++ moment;
